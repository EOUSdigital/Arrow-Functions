...
//TODO  🧪 Arrow Function Exercises


//! 🔹 Basic Form & Syntax

//  1. Create an arrow function that returns the number 7.
const first = () => 7;
console.log(first());                               //  ✅ Correct — logs: 7

//  🎉 Perfect use of:
//  • No parameters → ()
//  • Single-line return → no return or {} needed

//  2. Create an arrow function that takes a number as input and returns its square.
const second = number => number * number;
console.log(second(4));

//  3. Create an arrow function that takes a name and returns "Hello, <name>!"
const third = name => `Hello, ${name}`;
console.log(third("John"));

//! 🔹 Array Methods

//  4. Use .map() with an arrow function to triple each number in [1, 2, 3]
const numbers3 = [1, 2, 3];
const forth = numbers3.map(num => num * 3);
console.log(forth);

//  5. Use .filter() to return only the words longer than 4 letters in ["car", "train", "bicycle", "bus"]
const words = ["car", "train", "bicycle", "bus"];
const fifth = words.filter(word => word.length > 4);
console.log(fifth);

//  6. Use .find() to get the first number divisible by 3 in [4, 9, 16, 21]
const numbers4 = [4, 9, 16, 21];
const sixth = numbers4.find(num => num % 3 === 0);
console.log(sixth);

//! 🔹 Logic & Conditions
//  7. Write an arrow function that takes an age and returns "Adult" if 18 or over, else "Minor"
const seventh = age => age >= 18 ? "Adult" : "Minor";
console.log(seventh(20));
console.log(seventh(10));

//  8. Write an arrow function that checks if a word ends with the letter "s"
const eighth = word => word[word.length - 1].toLowerCase() === "s";

console.log(eighth("miss"));
console.log(eighth("macS"));

//  9. Write an arrow function that returns true if a number is between 10 and 20
const ninth = num => num >= 10 && num <= 20;
console.log(ninth(10));

//! 🔹 Returning Objects & Advanced Use
//  10. Write an arrow function that returns the object { id: 1, status: "ok" }
const tenth = obj => ({ id: 1, status: "ok" });
console.log(tenth());

//  11. Write an arrow function that takes a name and score, and returns { name, score }
const eleventh = score => ({ name: "John", score: 1});
console.log(eleventh());

//  12. Use .forEach() with an arrow function to log each item in ["apples", "oranges", "pears"]
const fruits = ["apples", "oranges", "pears"];
const twelfth = () =>  fruits.forEach(element => console.log(element));
